...
const Glasses = () => {
  ...
  const banners = [
    { id: "1", image: require("../assets/glasses b1.png") },
    { id: "2", image: require("../assets/glasses b2.png") }, // Add a second banner image
  ];
      ...
      <ScrollView contentContainerStyle={styles.contentContainer}>
        ...
        <View style={styles.carouselContainer}>
          <Carousel
            ...
            autoplayInterval={2000} // Slide interval of 2 seconds
          />
